...
function BaseDataLoader:LoadBatchForAllDatasetstest()
  return {},{},{},{}
end
function BaseDataLoader:LoadBatchForAllDatasetstrain()
  return {},{},{},{},{}
end
...
-- |return|: a table of two tables, each corresponding to 
-- the batch for dataset A and dataset B
function BaseDataLoader:GetNextBatchtest()
  self.data_tm:reset()
  self.data_tm:resume()
  local dataA, dataB, pathA, pathB = self:LoadBatchForAllDatasetstest()
  self.data_tm:stop()
  return dataA, dataB, pathA, pathB
end
function BaseDataLoader:GetNextBatchtrain()
  self.data_tm:reset()
  self.data_tm:resume()
  local dataA, dataB, pathA, pathB, CSRA, CSRB = self:LoadBatchForAllDatasetstrain()
  self.data_tm:stop()
  return dataA, dataB, pathA, pathB, CSRA, CSRB
end
