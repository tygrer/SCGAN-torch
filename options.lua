...
local opt_train = {
   ...
   save_latest_freq = 100,     -- save the latest model every latest_freq sgd iterations (overwrites the previous latest model)
   print_freq = 50,             -- print the debug information every print_freq iterations
   save_display_freq = 50,    -- save the current display of results every save_display_freq_iterations
